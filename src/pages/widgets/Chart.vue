  ...
  <div id="social">
    <v-container grid-list-xl fluid>
      ...
      <v-layout row wrap>
        ...
        <v-flex lg4 sm6 xs12>
          <box-chart title="Monthly Sales" sub-title="10%" icon="trending_up" card-color="pink" :data="dataset.monthVisit" :chart-color="[color.pink.lighten2]" type="bar">
          </box-chart>
        </v-flex>
        <v-flex lg4 sm6 xs12>
          <box-chart card-color="indigo" title="Page views" sub-title="10%" icon="trending_up" :data="dataset.monthVisit" :chart-color="[color.shades.white]" type="line">
          </box-chart>
        </v-flex>
      </v-layout>
      <!-- complex chart -->
          ...
          <v-card dark color="green">
            <v-card-title>
              <div class="layout row ma-0">
                ...
                <v-spacer></v-spacer>
                <div class="caption">
                  <v-icon>trending_up</v-icon> 20%</div>
              </div>
            </v-card-title>
            <v-card-media class="white--text">
              <e-chart ref="chart" :path-option="[
