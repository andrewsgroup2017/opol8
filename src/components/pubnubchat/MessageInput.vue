<template>
  <div class="message-input">
    <textarea ref="messageInput" placeholder="message..." maxlength="20000" @keydown.enter="submitMessage" @keyup="isTyping"></textarea>
  </div>
</template>
...
export default {
  ...
  methods: {
    isTyping (event) {
      ...
      const currentChatObject = state.chat.chats[state.chat.currentChat]
