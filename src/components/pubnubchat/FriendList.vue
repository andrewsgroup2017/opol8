<template>
  <div class="friend-list">
    ...
    <friend-list-item v-for="(friend, index) of friends" :key="index" :index="index" :name="friend.name" :lastMessage="friend.lastMessage" :avatar="friend.avatar"></friend-list-item>
  </div>
</template>
